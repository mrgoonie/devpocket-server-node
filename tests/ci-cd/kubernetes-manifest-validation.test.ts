      ...
      describe(`${env.name.toUpperCase()} Environment`, () => {
        ...
        test('should generate deployment manifest with correct environment values', () => {
          ...
          content = content
            ...
            .replace(/image: docker\.io\/digitop\/devpocket-nodejs:latest/g, `image: docker.io/digitop/devpocket-nodejs:${env.imageTag}`)
        ...
        test('should generate ingress manifest with correct domain and namespace', () => {
          ...
          if (env.name === 'dev') {
            content = content
              ...
              .replace(/devpocket-nodejs\.prod\.diginext\.site/g, 'devpocket-nodejs.dev.diginext.site')
              .replace(/tls-devpocket-nodejs-prod-diginext-site/g, 'tls-devpocket-nodejs-dev-diginext-site');
          } else if (env.name === 'beta') {
            content = content
              .replace(/tls-api-devpocket-app/g, 'tls-api-beta-devpocket-app')
              .replace(/devpocket-nodejs\.prod\.diginext\.site/g, 'devpocket-nodejs.beta.diginext.site')
              .replace(/tls-devpocket-nodejs-prod-diginext-site/g, 'tls-devpocket-nodejs-beta-diginext-site');
          }
